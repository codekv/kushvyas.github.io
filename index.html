...
<!-- Mirrored from demo.themesuccess.com/templates/kayden/demo7.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Jun 2021 08:41:09 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Kush Vyas</title>
    <!--Usefull Meta-->
    ...
    <link rel="stylesheet" href="css/kayden_7.css">
</head>
...
<!--                        <div class="kt-t">
                ...
                <div class="kayden-logo">
                    <a href="#">
<!--                        <img src="images/logo.svg" height="30" alt="kayden">-->
                        <h3 alt="kayden"> Kushvyas </h3>
                    </a>
                </div>
                <!--Header Logo END-->
                <!--Header Info START-->
...
<!--    <div class="offcanvas offcanvas-start" id="kaydenOffCanvas">
    ...
    <section id="home" class="home vh-100">
        <!--Home Video Background START-->
        <div class="video-overlay"></div>
        <div id="kayden_video" class="home-background position-absolute top-0 start-0 w-100 h-100" data-property="{videoURL:'https://www.youtube.com/watch?v=2Gg6Seob5Mg',containment:'#home', showControls:false, autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, quality:'default'}"></div>
        <!--Home Background END-->
        <!--Home Container START-->
        <div class="container h-100 position-relative">
            <div class="home-details text-center w-100 h-100 d-flex align-items-center">
                <div class="home-details-inner w-100">
                    <p class="welcome_text fs-4" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500"><span class="typed_text" data-options="Web Developer, App Development"></span></p>
                    <h1 class="fs-1 fw-bold  kayden-underline-center kayden-underline-big d-inline-block" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">I'm kush Vyas </h1>
                </div>
            </div>
        </div>
        <!--Home Container END-->
                ...
                <div class="row w-100">
                    ...
                    <div class="offset-md-1 col-md-4">
                        <div class="about-image w-100">
                            <img src="images/code.kv.png" class="kayden-shadow rounded-3 w-100" alt="kayden Picture" data-aos="zoom-in" data-aos-duration="800">
                        </div>
                    </div>
                    ...
                    <div class="offset-md-1 col-md-6 mt-5 mt-md-0">
                        <div class="h-100 d-flex align-items-center justify-content-center">
                            <div class="about-details">
                                <h2 class="fs-3 fw-bold mb-5">I'm Kush Vyas</h2>
                                <p class="text-secondary mb-5">Hi! There are many </p>
                                <!--Social Links START-->
                                <ul class="social-links list-inline mb-5">
                                    <li class="list-inline-item">
                                        <a href="https://www.instagram.com/code.kv/" title="Instagram">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="https://github.com/codekv" title="git">
                ...
                <div class="row gy-5">
                        ...
                        <div class="row gx-3 gy-5">
                            <div class="col-6">
                                ...
                                <div class="fact d-flex flex-column align-items-center align-items-md-start">
                                    <h3 class="fs-2 d-inline-block"><span class="tmcounter" data-from="0" data-to="3" data-speed="1500">0</span><sup>+</sup></h3>
                            ...
                            <div class="col-6">
                                <!--Facts Item START-->
                                <div class="fact d-flex flex-column align-items-center align-items-md-start">
                                    <h3 class="fs-2 d-inline-block" ><span class="tmcounter" data-from="0" data-to="50" data-speed="1500">0</span></h3>
                            ...
                            <div class="col-6">
                                <!--Facts Item START-->
                                <div class="fact d-flex flex-column align-items-center align-items-md-start">
                                    <h3 class="fs-2 d-inline-block"><span class="tmcounter" data-from="0" data-to="150" data-speed="1500">0</span></h3>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="skills_container">
                            ...
                            <!--Progress Bar START-->
                            <div class="mb-4">
                                <label class="mb-3 fs-6">Android development 80%</label>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-loadAnimation" data-percent="80" style="width: 0%;" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <!--Progress Bar END-->
                            <!--Progress Bar START-->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="w-25 d-none d-sm-table-cell">
                                    <span class="fw-light fs-5">2018-2021</span>
                                </td>
                                <td class="w-50 d-none d-sm-table-cell">
                                    <span class="fw-bold fs-5">Becholr Of Computer Science</span>
                                </td>
                                <td class="w-25 d-none d-sm-table-cell">
                            ...
                            <div class="contact-details d-flex flex-row align-items-center mb-3">
                                ...
                                <div class="cd-info fs-5 font-family-secondary">
                                    <a href="#" class="text-white">
                                        <span class="__cf_email__" ">codekv2@gmail.com</span>
                                    </a>
                                </div>
                            </div>
                            <!--Contact Details END-->
...
<!--                            <div class="contact-details d-flex flex-row align-items-center">
    ...
    <footer class="kayden-footer py-4">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center py-3">
                ...
                <!--Social Links END-->
                <!--Copyright START-->
                <p class="text-center m-0">2021 ©.  Developed and Designed by Kushvyas</p>
                <!--Copyright END-->
            </div>
        </div>
    </footer>
    ...
    <!--JavaScript START-->
    <!--Popper-->
    <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="../../../cdn.jsdelivr.net/npm/%40popperjs/core%402.9.2/dist/umd/popper.min.js"></script>
    <!--Bootstrap-->
    ...
    <script src="js/kayden.js"></script>
    <!--JavaScript END-->
</body>
